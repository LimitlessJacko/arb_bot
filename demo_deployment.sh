...
# Configuration
VPS_IP="YOUR_VPS_IP"
GITHUB_REPO="https://github.com/Limitlessjacko/arb_bot.git"
...
demonstrate_bot_deployment() {
    ...
    log_command "git clone $GITHUB_REPO /opt/arb_bot"
    log_command "cd /opt/arb_bot"
...
show_final_summary() {
    ...
    echo "  • Update code: cd /opt/arb_bot && git pull && ./deploy.sh update"
...
main() {
    ...
    echo "3. Run: curl -sSL https://raw.githubusercontent.com/YOUR-USERNAME/arb_bot/main/deploy.sh | sudo bash"
    echo ""
}
